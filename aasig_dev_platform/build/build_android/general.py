...
class prepare_directories(BaseAndroidTask):
...
class install_dependencies(BaseAndroidTask):
    ...
    def execute(self):
        ...
        self.subprocess_must_succeed("sudo -S apt install -y git devscripts config-package-dev debhelper-compat golang apt-utils")
